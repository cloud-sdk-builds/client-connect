...
[`@aws-sdk/client-connect`](https://www.npmjs.com/package/@aws-sdk/client-connect/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+uXoCa0Np8sxUPID9f5EtEXdShHdwfAYzkG+RLNCi+pnk0Xr1m7H3OUKTq4GJrtm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-connect": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect@3.130.0/index.min.mjs": "sha384-+uXoCa0Np8sxUPID9f5EtEXdShHdwfAYzkG+RLNCi+pnk0Xr1m7H3OUKTq4GJrtm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-connect/blob/refs/tags/3.130.0/LICENSE
```
