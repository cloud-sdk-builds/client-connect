...
[`@aws-sdk/client-connect`](https://www.npmjs.com/package/@aws-sdk/client-connect/v/3.1100.0).
...
- @aws-sdk/client-connect v3.1100.0 - [https://cloud-sdk-builds.github.io/?sdk=client-connect&version=3.1100.0](https://cloud-sdk-builds.github.io/?sdk=client-connect&version=3.1100.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect@3.1100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O8q3rWQsr1rZTSaGu+WU+N+rPRpajLiwyMmAqtcfuyYZP7iZ1IE11CPR2rUca9Ez
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-connect": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect@3.1100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect@3.1100.0/index.min.mjs": "sha384-O8q3rWQsr1rZTSaGu+WU+N+rPRpajLiwyMmAqtcfuyYZP7iZ1IE11CPR2rUca9Ez"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-connect/blob/refs/tags/3.1100.0/LICENSE
```
